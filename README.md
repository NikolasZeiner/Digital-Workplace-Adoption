...
behavioral event data, then delivered a 2-page Power BI executive scorecard
measuring adoption trends, feature utilization, and at-risk user identification
across 7 departments.

## Dashboard Preview

![Executive Overview](Adoption.png)
...
- 6 KPI cards: Total Colleagues, Active Users, Adoption Rate, Avg Session
  Duration, High Risk Users, Engaged Users
...
| adoption_dept_scorecard.csv | Department scorecard with engagement and adoption rates |
...
| adoption_monthly_trend.csv | Monthly sessions, actions, duration, and adoption rate |
...
Telemetry Analysis · Enterprise Technology Analytics
